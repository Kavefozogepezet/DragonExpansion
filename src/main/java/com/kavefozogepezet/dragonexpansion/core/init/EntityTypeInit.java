...
public class EntityTypeInit {
    ...
    public static final RegistryObject<EntityType<RideableDragonEntity>> RIDEABLE_DRAGON =
            ENTITY_TYPES.register("rideable_entity", ()->EntityType.Builder
                    .of(RideableDragonEntity::new, EntityClassification.CREATURE)
                    .sized(3.0f, 3.0f)
                    .fireImmune()
